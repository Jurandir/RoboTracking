SELECT TOP 1
	 ...
	 TRANSP.FONE                                           AS content_transportador_telefone,
	 TRANSP.CGC                                            AS content_transportador_cnpj,
	 TRANSP.NOME                                           AS content_transportador_nomeFantasia,
	 'TERMACO LOGISTICA'                                   AS content_transportador_nome,
	 NFR1.CHAVENFE                                         AS content_danfe,
	 FORMAT(NFR1.DATA,'yyyy-MM-ddThh:mm:ss-03')            AS content_dataEmissaoDanfe,
	 CIDCLI.UF                                             AS content_content_endereco_uf,
